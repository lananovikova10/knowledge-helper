"""
Django settings for kb_portal project.
...
SECRET_KEY = 'django-insecure-yn7=c!_q+a#h+cyb=ya)zaf*wvgpj^)yw=sb@=d_*hi1ln40i0'
...
WSGI_APPLICATION = 'kb_portal.wsgi.application'
